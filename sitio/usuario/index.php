...
$seccionesDisp = ['home', 'productos', 'nuevo-producto', 'editar-producto', '404'];
...
<head>
    <meta charset="UTF-8">
    <title>Federico La Torre Segundo TP: Usuarios Administrativos</title>
    ...
    <header class="header">
        ...
        <nav>
            <ul>
                ...
                <li><a href="index.php?s=nuevo-producto">Nuevo producto</a></li>
                <li><a href="../acciones/logout.php">Cerrar Sesión</a></li>
